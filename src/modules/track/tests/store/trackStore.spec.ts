...
// Mock composables
vi.mock('../../composables/useTrackQueries', () => ({
  useTrackQueries: () => ({
    searchQuery: { value: '' },
...
describe('useTrackStore', () => {
  ...
  describe('computed properties', () => {
    it('should compute totalPages correctly', () => {
      ...
      // itemsPerPage from composable is 20
  ...
  describe('actions', () => {
    it('should fetch tracks successfully', async () => {
      const { trackApi } = await import('../../api/trackApi');
    ...
    it('should delete multiple tracks successfully', async () => {
      ...
      // Note: clearSelectedTracks is called internally but we don't test implementation details
    });
